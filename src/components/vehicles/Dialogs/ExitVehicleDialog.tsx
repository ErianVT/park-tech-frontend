    ...
    async function handleExitVehicle() {
        try {
            ...
            if (err instanceof AxiosError) {
                ...
                toast.error(errorMessage || "Erro ao registar saída")
            }
        }
    }
    return (
        <Dialog open={open} onOpenChange={setOpen}>
            ...
            <DialogContent className="sm:max-w-106.25">
                ...
                <div className="text-center">
                    <p className="text-muted-foreground">Você realmente deseja registrar a saida do Veículo?</p>
                ...
                <DialogFooter className="w-full grid grid-cols-2 mt-4">
                    ...
                    <Button onClick={handleExitVehicle} disabled={isLoading} >Confirmar Saída</Button>
                </DialogFooter>
            </DialogContent>
        </Dialog>
    )
