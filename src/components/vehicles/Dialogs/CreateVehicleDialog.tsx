        ...
        <Dialog open={open} onOpenChange={setOpen}>
            ...
            <DialogContent className="sm:max-w-106.25">
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="grid gap-4">
                    ...
                    <Input id="plate" label="Placa" placeholder="RC5D098" error={errors.plate?.message} {...register("plate")} />
                    <Input id="model" label="Modelo" placeholder="ex: Corolla" error={errors.model?.message} {...register("model")} />
                    <Input id="color" label="Cor" placeholder="ex: Vermelho" error={errors.color?.message} {...register("color")} />
