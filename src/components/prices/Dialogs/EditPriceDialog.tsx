    ...
    const onSubmit = async (data: EditPriceSchema) => {
        ...
        try {
            ...
            if (err instanceof AxiosError) {
                ...
                toast.success(errorMessage || "Erro ao editar o Preço!")
            }
        }
    }
        ...
        <Dialog open={open} onOpenChange={setOpen}>
            ...
            <DialogContent className="sm:max-w-106.25">
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Preencha os dados abaixo para alterar o Preço
                    </DialogDescription>
                </DialogHeader>
                            ...
                            return (
                                <>
                                    ...
                                    {errors && errors.isActive?.message && (
                                        <p className="text-red-500 text-[12px]">{errors.isActive?.message}</p>
                                    )}
                                </>
                            )
                        }} />
