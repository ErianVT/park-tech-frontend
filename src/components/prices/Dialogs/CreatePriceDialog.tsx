...
import { createPriceSchema, type CreatePriceSchema } from "@/schemas/prices/createPriceSchema"
    ...
    const onSubmit = async (data: CreatePriceSchema) => {
        try {
            ...
            if (err instanceof AxiosError) {
                ...
                toast.success(errorMessage || "Erro ao criar o Preço!")
            }
        }
    }
        ...
        <Dialog open={open} onOpenChange={setOpen}>
            ...
            <DialogContent className="sm:max-w-106.25">
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="grid gap-4">
                    ...
                    <Input id="firstHourPrice" label="Preço primeira hora" placeholder="ex: 20" error={errors.firstHourPrice?.message} {...register("firstHourPrice", { valueAsNumber: true })} />
                    <Input id="additionalHourPrice" label="Preço horas adicionais" placeholder="Ex: 10" error={errors.additionalHourPrice?.message} {...register("additionalHourPrice", { valueAsNumber: true })} />
